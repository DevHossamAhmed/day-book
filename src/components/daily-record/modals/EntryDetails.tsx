  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-end z-[9999] pointer-events-none">
        <div
          className="bg-[var(--color-overviewTab)] w-full max-w-2xl h-full shadow-2xl animate-slide-in overflow-y-auto pointer-events-auto"
          ...
          <div className="p-6">
            ...
            <div className="flex items-start justify-between mb-8">
              <div>
                ...
                <h2 className="text-xl font-semibold ">{balance.source}</h2>
              </div>
            ...
            {/* Note Section */}
            <div className="mb-8">
              <h3 className="text-base font-semibold  mb-3">Note</h3>
